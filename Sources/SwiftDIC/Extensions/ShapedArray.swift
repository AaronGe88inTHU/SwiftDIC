...
@usableFromInline
internal class ArrayTensorBuffer<Scalar> {
    var array: [Scalar]
    let count: Int
...
public struct ShapedArray<Scalar>: _ShapedArrayProtocol {
    ...
    internal var buffer: ArrayTensorBuffer<Scalar>
    
    /// The dimensions of the array.
    public private(set) var shape: [Int]
    
    /// Creates a `ShapedArray` from a `TensorBuffer` and a shape.
    internal init(buffer: __owned ArrayTensorBuffer<Scalar>, shape: __owned [Int]) {
        precondition(
